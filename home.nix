      ...
      xdg.configFile."noctalia/theme-sync.sh" = {
        ...
        text = ''
          ...
          if [ -d "$HOME/notes/.obsidian" ]; then
            ...
            : "''${ACC_FG:=#000000}"
            cat > "$HOME/notes/.obsidian/snippets/noctalia.css" <<EOF
            /* Generated by noctalia-theme-sync.sh - follows the wallpaper */
            body {
              --accent-h: $AH;
              --accent-s: $AS%;
              --accent-l: $AL%;
              --interactive-accent: $ACC;
              --interactive-accent-hover: $ACC;
              --text-on-accent: $ACC_FG;
              --background-primary: $BG;
              --background-primary-alt: $CARD;
              --background-secondary: $CARD;
              --background-secondary-alt: $POP;
              --background-modifier-border: $BORD;
              --text-normal: $FG;
              --text-muted: $MUT;
              --text-faint: $MUT;
            }
